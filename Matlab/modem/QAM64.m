%%Modulated signal & Constellation Diagram of 64-QAM Modulation
...
subplot(3,1,2);
plot(TxSig); grid minor; title('64-QAM Modulated Signal'); 
xlim([0,N*10^3+N]);
subplot(3,1,3);
plot(RxSig); grid minor; title('64-QAM Modulated Signal with AWGN');
xlim([0,N*10^3+N]);
% Constellation Diagram of the Rx
scatterplot(r); grid minor;
title('Constellation Diagram of 64-QAM')
